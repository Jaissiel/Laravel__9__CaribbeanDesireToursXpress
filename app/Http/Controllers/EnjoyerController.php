...
class EnjoyerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $enjoyer_found = Enjoyer::where('enjoyer',$enjoyer) -> where('passswword',$passswword)  ->get() ->count();
        if ( $enjoyer_found == 1){
           return redirect('tours/create');
        }
        else{
            return redirect('/admin')->with('message', 'Usuario no Valido favor de rectificar');
