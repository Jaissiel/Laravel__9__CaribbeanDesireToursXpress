...
<div class="container" id="enjoyer" style="margin-top:0px">
    <form method="POST" action="enjoyer" name="login_form">
        @csrf   
        @method('head')
        <div class="row">
            <div class="col-sm-12">
...
<script> 
	function ValidaCampos()  {
        ...
        let jvi_mail_correcto =  /[\@]/;
        
        
        if (login_form.enjoyer.value  == "")   {
            alert("El campo: Usuario/Enjoyer, no debe estar vacío, favor de verificar ");    login_form.enjoyer.focus(); return false;
        }  
